...
package smartfish.managers.process
{
    ...
    public class ProcessManager
    {
		...
		public function ProcessManager(single:SingletonEnforcer)
		{
		...
		public static function getInstance():ProcessManager {
			if (!_instance) {
				_instance = new ProcessManager(new SingletonEnforcer());
			}
			return _instance;
		}
        ...
        public function start():void
        {
            ...
            lastTime = -1.0;
            elapsed = 0.0;
			mainStage.addEventListener(Event.ENTER_FRAME, onFrame);
            started = true;
        }
        ...
        public function stop():void
        {
            ...
            started = false;
			mainStage.removeEventListener(Event.ENTER_FRAME, onFrame);
        }
		 ...
		 */
		private function clamp(v:Number, min:Number = 0, max:Number = 1):Number
		{
			if(v < min) return min;
			if(v > max) return max;
			return v;
        ...
        protected var tickedObjects:Array = [];
		protected var animatedObjects:Array = [];
        ...
        protected var thinkHeap:smartfish.managers.process.SimplePriorityQueue = new SimplePriorityQueue(1024);
    }
}
